...
var idToFilePath = function(illustId, namePattern)
{
...
PixivDownloader.prototype.main = function (maxPage, refreshToken)
{
	pixiv
		.refreshAccessToken(refreshToken).then(function () {
...
PixivDownloader.prototype.userBookmarksIllustDownload = function (userId, maxPage, refreshToken)
{
	pixiv
		.refreshAccessToken(refreshToken).then(function () {
			return pixiv.userBookmarksIllust(userId).then(function (json) {
				createDownloadAndNexetPromises(json, maxPage);
			}).catch(function (e) {
				console.log(e);
				throw e;
